...
const css = [
  fs.readFileSync(new URL('../css/main.css', import.meta.url), 'utf8'),
  fs.readFileSync(new URL('../css/classificacao.css', import.meta.url), 'utf8'),
].join('\n');
...
assert.match(fs.readFileSync(new URL('../index.html', import.meta.url), 'utf8'), /main\.css\?v=2\.0/);
assert.match(fs.readFileSync(new URL('../sw-v5.js', import.meta.url), 'utf8'), /refactor-full-v11/);

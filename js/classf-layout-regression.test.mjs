...
assert.match(fs.readFileSync(new URL('../index.html', import.meta.url), 'utf8'), /styles4\.css\?v=\d+/);
assert.match(fs.readFileSync(new URL('../sw-v5.js', import.meta.url), 'utf8'), /refactor-full-v10/);

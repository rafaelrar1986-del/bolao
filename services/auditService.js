...
exports.generateAuditCSV = async (leagueId, groupName) => {
    ...
    try {
        ...
        allBets.forEach(bet => {
            ...
            // Processa e injeta os dados do pódio (podium é array [String] no schema Bet)
            const podiumArr = bet.podium || [];
            rowData.podium_1st = podiumArr[0] || "---";
            rowData.podium_2nd = podiumArr[1] || "---";
            rowData.podium_3rd = podiumArr[2] || "---";
            rowData.podium_4th = podiumArr[3] || "---";

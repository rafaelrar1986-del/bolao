...
function getMaxPointsPerMatch(
  ...
  // No modo dependente, o maior resultado possível é o placar exato,
  // somado ao classificado quando a partida for de mata-mata.
  // Sem fase informada, retornamos o máximo possível considerando mata-mata.
  void champRules;

  if (rules.scoringMode === 'dependent') {
    return rules.exactScore + rules.qualifier;
  }
